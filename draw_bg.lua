...
function draw_ring(cr, center_x, center_y, radius, thickness, percentage, color)
    ...
    cairo_set_source_rgba(cr, 144, 255, 240, 0.26)
...
function efecto_ocilacion(cr, x, y,radius) 
    ...
    cairo_arc(cr, x,y,radius -10, angulo_inicio, angulo_fin)
    cairo_stroke(cr)
end
...
function conky_main()
    ...
    efecto_ocilacion(cr, 70, 235, 35, {0.27, 0.90, 0.13})
    
    efecto_ocilacion(cr, 180,235, 35, {0.70, 0.90, .013})
